"""Impact harness for the simplified Q1–Q4 allocator.
...
This is the "run the Etobicoke list through and show the impact" deliverable.
...
from asra_matcher import batch, sheets, simple
